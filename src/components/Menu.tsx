...
function Menu({onClose}: Props) {
  ...
  return (
    ...
    fixed top-[30px] left-0 z-[9999]
    flex flex-col items-center
    space-y-10 duration-300
    ${isOpen?"":"opacity-0"}
    `}>
    <div className='w-1/3 flex justify-center items-center space-x-4 py-10'>
    ...
    <input 
    className='h-[40px] w-full  bg-neutral-400 text-neutral-700 text-xl
